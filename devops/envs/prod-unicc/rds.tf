...
module "db_default" {
  source = "git::git@bitbucket.org:awsopda/who-seq-treat-tbkb-terraform-modules.git//rds?ref=rds-v1.1"
  ...
  # snapshot_identifier = data.aws_db_snapshot.prod
  snapshot_identifier = "tbkbprod"
