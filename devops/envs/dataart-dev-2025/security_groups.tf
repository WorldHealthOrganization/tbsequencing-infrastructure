module "sg" {
  source           = "git::https://github.com/finddx/seq-treat-tbkb-terraform-modules.git//security-groups?ref=sg-v1.3"
  ...
  sg_rules = {
    ingress = {
      ...
      rule01 = {
        ...
        protocol                 = "TCP"
        cidr_blocks              = null
        description              = "Allow all trafic to itself, required by Glue"
      },
    ...
    egress = {
      ...
      rule09 = {
        security_group_id             = module.sg.security_group_id["glue"]
        destination_security_group_id = module.sg.security_group_id["glue"]
        prefix_list_id                = null
        from_port                     = null
        to_port                       = null
        protocol                      = "all"
        cidr_blocks                   = null
        description                   = "Glue connection requires all egress ports to itself."
      },
      rule08 = {
        security_group_id             = module.sg.security_group_id["glue"]
        ...
        protocol                      = "TCP"
        cidr_blocks                   = null
        description                   = "All trafic from the RDS."
      },
      rule07 = {
        security_group_id             = module.sg.security_group_id["glue"]
        destination_security_group_id = module.sg.security_group_id["vpc-endpoints"]
        prefix_list_id                = null
        from_port                     = 443
        to_port                       = 443
        protocol                      = "TCP"
        cidr_blocks                   = null
        description                   = "Needs access to the Interface endpoints (secrets manager)"
      },
      rule06 = {
        security_group_id             = module.sg.security_group_id["glue"]
        destination_security_group_id = null
        prefix_list_id                = data.aws_ec2_managed_prefix_list.s3_prefix_link.id
        from_port                     = 443
        to_port                       = 443
        protocol                      = "TCP"
        cidr_blocks                   = null
