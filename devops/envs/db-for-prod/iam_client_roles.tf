...
locals {
  repo_mappings = {
    "my-github-actions-frontend" = {
      repos = [
        "repo:${var.github_org_name}//seq-treat-tbkb-frontend:environment:${var.environment}"
      ]
    }
    "my-github-actions-backend" = {
      repos = [
        "repo:${var.github_org_name}/seq-treat-tbkb-backend:environment:${var.environment}"
      ]
    }
    "my-github-actions-push-glue" = {
      repos = [
        "repo:${var.github_org_name}/seq-treat-tbkb-bioinfoanalysis:environment:${var.environment}",
        "repo:${var.github_org_name}/seq-treat-tbkb-antimalware:environment:${var.environment}",
        "repo:${var.github_org_name}/seq-treat-tbkb-ncbi-sync:environment:${var.environment}",
        "repo:${var.github_org_name}/seq-treat-tbkb-backend:environment:${var.environment}"
      ]
    },
    "my-github-actions-terraform" = {
      repos = [
        "repo:${var.github_org_name}/seq-treat-tbkb-bioinfoanalysis:environment:${var.environment}",
        "repo:${var.github_org_name}/seq-treat-tbkb-infrastructure:environment:${var.environment}",
        "repo:${var.github_org_name}/seq-treat-tbkb-ncbi-sync:environment:${var.environment}",
      ]
    }
  }
  ...
  policy_mapping = {
    ...
    terraform-admin = {
      role   = module.roles.role_name["my-github-actions-terraform"]
